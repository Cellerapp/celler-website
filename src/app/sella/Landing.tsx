...
const TESTIMONIALS = [
	{
		...
		quote:
			"Sella has made paying bills so much easier. I can buy airtime and pay for electricity all in one place!",
		rating: 5,
	},
	{
		name: "Chukwuemeka N.",
		role: "Student",
		quote:
			"The best rates for data bundles. I save money every month using Sella.",
		rating: 5,
	},
	{
		name: "Fatima A.",
			...
			<nav className="fixed top-0 inset-x-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/40">
				<div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
					...
					<div className="flex items-center gap-3">
						...
						<Link
							href="https://web.celler.app/signup"
						...
						<div className="space-y-8">
							<div className="space-y-4">
								...
								<p className="text-lg text-muted-foreground max-w-md">
									Buy airtime, pay for data, electricity, TV subscriptions and
									more — all from one simple, secure app.
								</p>
							</div>
								...
								<div className="px-5 pt-4 pb-20 space-y-5">
									...
									>
										...
										<div className="px-4 py-2 bg-white/10">
											<p className="text-white/70 text-[9px] tracking-wide">
												ACCT NO: 0765 6736 7282
											</p>
										</div>
									</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground max-w-2xl mx-auto">
							From airtime to electricity, Sella covers all your essential bill
				...
				<div className="max-w-4xl mx-auto">
					...
					>
						...
						<p className="text-white/70 max-w-md mx-auto mb-8">
							Join thousands of Nigerians who are already paying bills smarter
							with Sella
						</p>
