...
export default function Home() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      // Rotate the message
      setMessage((prevMessage) => (prevMessage % 2) + 1);
    }, 10000);
        ...
        <div className="w-4/5 lgss:w-2/5 mx-auto">
          ...
          <Fade direction="up" triggerOnce>
            <h4 className="text-center  mt-3 text-[14px] lgss:text-[16px] text-secondary ">
              Discover how easy it is to start your crypto journey in less than
              10 minutes using these three simple steps.
            </h4>
          </Fade>
        </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4 mt-4 ">
              ...
              <Fade direction="up" triggerOnce>
                ...
                <h4 className="text-center  text-[15px]  text-white px-4">
                  Get started by signing up or logging in to explore Cryptpay
                  incredible benefits.
                </h4>
              </Fade>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4 mt-4 ">
              ...
              <Fade direction="up" triggerOnce>
                ...
                <h4 className="text-center  text-[15px]  text-white px-4">
                  ...
                  helps to keep intruders away from you account.
                </h4>
              </Fade>
            </div>
          </div>
      ...
      <div className="bg-[#0C0D1D] py-10 px-4 xs:px-6 mds:px-12 md:px-16 lgss:px-12 xl:px-16  xxxl:px-[250px]">
        ...
        <div className="w-full flex-col lgss:flex-row flex justify-start items-center mt-20 lgss:mt-28  gap-6">
          <div className="hidden lgss:flex justify-center items-start gap-6  lgss:w-1/2">
            <div className="w-[8px] rounded-full bg-white h-[300px] flex flex-col">
              <div
                className={
                  message === 1
                    ? "bg-primary w-full h-1/2"
                    : "bg-white w-full h-1/2"
                }
              />
              <div
                className={
          ...
          <div className="w-10/12 mx-auto py-10 lgss:py-20  lgss:w-[45%] rounded-xl flex justify-center items-center bg-[#101226]">
            <Zoom direction="up" className="w-1/2">
              <Image
                src={message === 2 ? sellPhone : message === 1 ? buyPhone : ""}
                className="w-full "
                alt=""
              />
            </Zoom>
        ...
        <div className="w-4/5 lgss:w-2/5 mx-auto">
          ...
          <Fade triggerOnce direction="up">
            <h4 className="text-center  mt-3 text-[14px] lgss:text-[16px] text-secondary ">
              ...
              rewarding. Use Cryptpay to enjoy the followimg
            </h4>
          </Fade>
        </div>
        <div
            ...
            <Fade triggerOnce direction="left" duration={1500}>
              ...
              >
                ...
                {activeQuestion === 5 && (
                  <Fade triggerOnce direction="up">
                    <h4 className="text-left text-secondary mt-4 text-[14px]">
                      Cryptpay charges fees for certain transactions and
                      services. These may include trading fees, withdrawal fees,
                      and deposit fees, which vary depending on the type of
