        ...
        <div className="w-full lgss:w-2/5">
            ...
            >
              ...
              {activeQuestion === 1 && (
                <h4 className="text-left text-white mt-4 text-[14px]">
                  ...
                  seamless and efficient crypto experience, ensuring we stay
                  ahead in the ever-evolving digital finance world.
                </h4>
              )}
            </div>
          </Fade>
          ...
          <Fade triggerOnce direction="right">
            ...
            >
              ...
              {activeQuestion === 5 && (
                <h4 className="text-left text-white mt-4 text-[14px]">
                  Your experience matters to us. We offer 24/7 support and
                  tailor our services to meet your needs, ensuring a smooth and
