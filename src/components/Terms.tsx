  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full mt-8">
        ...
        <h4 className="text-[14px] mt-2 lgss:mt-[16px] leading-[30px] tracking-wide">
          Users agree not to engage in activities that could compromise the
          security, functionality, or accessibility of our services. This
          includes, but is not limited to, unauthorized access, data scraping,
          or any actions that violate our policies or disrupt the service for
          other users.
        </h4>
      </div>
      <div className="w-full mt-8">
        ...
        <h4 className="text-[14px] mt-2 lgss:mt-[16px] leading-[30px] tracking-wide">
          To access certain features and services, users may need to register an
          account. Users are responsible for maintaining the confidentiality of
          their account credentials and are liable for all activities conducted
          under their account.
        </h4>
      </div>
      <div className="w-full mt-8">
